...
- Alarm operasyon akışı büyük ölçüde tamamlandı: yeni/onaylandı/çözüldü, atanan kullanıcı, not, önem seviyesi, olay kapatma nedeni, yanlış alarm işareti ve detay paneli var. Filtrelenmiş alarm listesi açık alarm/yüksek öncelik/yanlış alarm oranı/ortalama çözüm süresi metrikleriyle raporlanır ve CSV olarak dışa aktarılabilir. Kalan iş bu rapor verisini eğitim seti geri besleme havuzuna ve zamanlanmış kurumsal raporlara bağlamak.
...
- Alarm sayfasında detay drawer, snapshot preview, kamera canlı görüntüsüne geçiş, toplu onaylama, not/atama/çözüm nedeni, önem seviyesi, yanlış alarm kapatma, filtreye bağlı rapor metrikleri ve CSV dışa aktarım akışları eklendi. Kalan iş eğitim seti geri besleme havuzu ve zamanlanmış rapor üretimi.
