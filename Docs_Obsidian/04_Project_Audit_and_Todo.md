...
- Kameralar listesinde arama, durum ve AI filtreleri eklendi. Kalan iş NVR/Kullanıcılar listelerinde arama/sıralama/sayfalama ve geniş listeler için server-side pagination.
