...
- 2026-07-22: Frontend API hata mesaji standardi genisletildi. Ortak `getApiErrorMessage` yardimcisi eklendi; kullanici yonetimi, alarm aksiyonlari ve NVR duzenleme inline/toast hatalari backend `detail` alanini veya okunabilir fallback mesajini gosterir. Login hata mesaji guvenlik icin genel tutulur.
